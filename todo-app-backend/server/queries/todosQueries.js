...
// post todo
const postTodo = `INSERT INTO todo.todos (todo_uuid, task, description, date_created, date_due, priority, user_uuid, list_uuid)
                  VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING todo_uuid;`
